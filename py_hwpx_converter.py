...
def convert_hwp_to_text(hwp_path: str, classpath_elements: list[str]) -> str:
    """
...
if __name__ == "__main__":
    ...
    classpath_elements = [
        ".",  # 현재 디렉토리
        "../hwp_server/hwp2hwpx/target/hwp2hwpx-1.0.0.jar",
        "../hwp_server/hwplib/target/hwplib-1.1.10.jar",
        "../hwp_server/hwpxlib/target/hwpxlib-1.0.5.jar"
    ]

    converted_text = convert_hwp_to_text(hwp_file, classpath_elements)
